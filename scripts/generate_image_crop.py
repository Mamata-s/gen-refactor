...
for i in range(71):
    ...
    ut.save_img_using_pil_lib(img,name,'../dataset/crop_factor_2/train/',upsample=False)
...
for i in range(71):
    ...
    k+=1
    shape = (data_hr[:,:,k].shape[1],data_hr[:,:,k].shape[0])
    ut.save_img_using_pil_lib(img,name,'../dataset/crop_factor_4/train/',upsample=False)
...
for i in range(71):
    ...
    k+=1
    shape = (data_hr[:,:,k].shape[1],data_hr[:,:,k].shape[0])
    ut.save_img_using_pil_lib(img,name,'../dataset/crop_factor_2/val/',upsample=False)
...
for i in range(71):
    ...
    k+=1
    shape = (data_hr[:,:,k].shape[1],data_hr[:,:,k].shape[0])
    ut.save_img_using_pil_lib(img,name,'../dataset/crop_factor_4/val/',upsample=False)
